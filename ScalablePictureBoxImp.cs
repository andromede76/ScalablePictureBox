...
namespace QAlbum
{
    ...
    internal partial class ScalablePictureBoxImp : System.Windows.Forms.UserControl
    {
		...
		public ScalablePictureBoxImp()
		{
            ...
            // Read icon images
            fitWidthImage = Util.GetImageFromScalablePictureBoxEmbeddedResource("QAlbum.showFitWidth.gif");
            showWholeImage = Util.GetImageFromScalablePictureBoxEmbeddedResource("QAlbum.showWhole.gif");
            showActualSizeImage = Util.GetImageFromScalablePictureBoxEmbeddedResource("QAlbum.showActualSize.gif");
